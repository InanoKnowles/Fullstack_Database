...
def update_task(task_name, task_instructions, assign_task_to)
    run_sql('UPDATE tasks SET task_name = $2, task_instructions = $3, assign_task_to) WHERE id = $1', [task_name, task_instructions, assign_task_to])
end
